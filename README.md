...
[**Direct script link**](https://raw.github.com/EnderDragonneau/Drawception-ANBT-fix/master/drawception-anbt.user.js) (use to install/update manually, or "save as...")
