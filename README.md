...
[**Direct script link**](https://raw.githubusercontent.com/EnderDragonneau/Drawception-ANBT-fix/master/drawception-anbt.user.js) (use to install/update manually, or "save as...")
...
- Mobile browsers / other / single use:
  - create a bookmark with the following URL:
    ...
    `javascript:void($.ajax({dataType:"script",cache:!0,url:"//rawgit.com/EnderDragonneau/Drawception-ANBT-fix/master/drawception-anbt.user.js"}))`
...
See https://raw.githubusercontent.com/EnderDragonneau/Drawception-ANBT-fix/master/CHANGELOG.txt